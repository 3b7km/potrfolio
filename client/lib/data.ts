export const projects = [
  {
    ...
    images: ["/photos/helwa-1.webp", "/photos/helwa-2.webp"],
    impact: [
      ...
      "Architected deep multi-channel tracking pixels (Meta, TikTok, Snapchat) to ensure 100% data fidelity for performance marketing campaigns.",
      "Optimized mobile checkout flow by minimizing input fields and reducing overall friction during the payment step."
    ],
    techStack: {
  ...
  },
  {
    ...
    description:
      "A comprehensive WordPress platform for Al-Manarh General Contracting and Business Services, specializing in streamlining governmental and construction-related procedures. The site effectively showcases a wide array of services, from industrial development licenses to urban entity permits and private company registrations, designed to facilitate business operations and ensure regulatory compliance.",
    metrics: "Regulatory Efficiency",
    metricContext:
      "Demonstrates significant expertise and efficiency in navigating complex regulatory landscapes and securing essential business permits.",
    url: "https://al-manarh.com/",
    images: ["/photos/almanarh-1.webp", "/photos/almanarh-2.webp"],
    impact: [
      "Streamlined presentation of governmental and construction-related services to improve user access and understanding.",
      "Developed a customized WordPress architecture to effectively categorize diverse services like urban entity permits and company registrations.",
      "Implemented SEO best practices to ensure high visibility for niche construction and regulatory search terms."
    ],
    techStack: {
