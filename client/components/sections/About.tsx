...
export default function About() {
  return (
    <section id="about" aria-label="About Youssef Abdelhakam" className="relative w-full py-32 bg-transparent pointer-events-auto border-b border-border/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <p className="text-2xl md:text-4xl lg:text-5xl font-syne leading-tight text-white/95">
          ...
          <div className="lg:col-span-3 flex flex-col gap-16">
            ...
            <div id="experience-list">
              ...
              <div className="flex flex-col gap-6" role="list">
                {experiences.map((exp) => (
                  <div key={`${exp.role}-${exp.year}`} role="listitem" className="flex flex-col gap-1">
