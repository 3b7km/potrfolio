...
export default function ExperienceContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submissions: number[] = JSON.parse(localStorage.getItem(submissionsKey) || "[]");
  ...
  return (
    <section id="contact" aria-label="Contact form and information" className="relative w-full py-48 md:py-64 bg-transparent pointer-events-auto border-t border-border/10">
          ...
          <div className="lg:col-span-6 lg:col-start-7 flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="flex flex-col gap-8" noValidate>
              ...
              <div className="relative group">
                ...
                />
                {errors.name && <p id="name-error" role="alert" className="text-red-400/70 text-xs mt-2">{errors.name}</p>}
              </div>
              ...
              <div className="relative group">
                ...
                />
                {errors.email && <p id="email-error" role="alert" className="text-red-400/70 text-xs mt-2">{errors.email}</p>}
              </div>
              ...
              <div className="relative group">
                ...
                />
                {errors.message && <p id="message-error" role="alert" className="text-red-400/70 text-xs mt-2">{errors.message}</p>}
              </div>
              ...
              <div className="sr-only" role="status" aria-live="polite" aria-atomic="true">
                ...
                {formState === "sent" && "Message sent successfully! I'll review and get back to you within 24 hours."}
                {rateLimitError && "Too many submissions. Please wait before sending another message."}
              </div>
              ...
              {rateLimitError && (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs opacity-80">Please wait a moment before sending another message.</p>
                  </div>
                </motion.div>
              )}
            </form>
