    ...
    >
      <div className="pointer-events-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mt-12 md:mt-24 w-full">
          ...
          >
            <div className="absolute inset-0 bg-background/40 blur-2xl -z-10 rounded-full" aria-hidden="true" />
        ...
        <div className="mt-[10vh] md:mt-[15vh] h-[30vh]" aria-hidden="true">
