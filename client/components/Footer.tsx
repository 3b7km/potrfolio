      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8">
        <div className="flex flex-col md:flex-row items-center justify-between text-xs text-muted gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-6">
            ...
            <a href="https://wa.me/201023329072" target="_blank" rel="noopener noreferrer" className="tap-target px-3 py-2 hover:text-foreground transition-colors rounded-md">WhatsApp</a>
          </div>
        </div>
      </div>
    </footer>
